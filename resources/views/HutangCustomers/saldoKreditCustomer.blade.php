...
<table class="table table-sm tabl-valign-middle table-hover" id="tableKreditCustomer">
    <thead>
        <tr>
            ...
            <th><i class="fa-solid fa-rupiah-sign float-left"></i> <span class="float-right">Nilai Kredit</span></th>
            <th><i class="fa-solid fa-rupiah-sign float-left"></i> <span class="float-right">Nilai Bayar</span></th>
