        ...
        @foreach($mouData as $mou)
            <tr>
                ...
                <td class="text-right">
                    ...
                    <a class="btn btn-info btn-sm DELETE-BTN" data-id="{{$mou->idm_unit}}" href="{{route('MoU')}}/tableMoU/DeleteMoU/{{$mou->idm_unit}}"><i class="fa-solid fa-trash-can"></i> Delete Permanently</a>
                </td>
            </tr>
        @endforeach
    </tbody>
