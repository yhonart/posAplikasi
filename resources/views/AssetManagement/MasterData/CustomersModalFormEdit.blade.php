    ...
    <div class="card-body">
        <form id="FormEditCustomer">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input type="text" name="registeredDate" id="registeredDate" value="{{$editCustomer->registered_date}}" class="form-control form-control-sm" data-inputmask="'mask': ['99-99-9999']" data-mask>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <select name="typePenjualan" id="typePenjualan" class="form-control form-control-sm">
                        <option value="{{$editCustomer->customer_type}}" readonly>{{$editCustomer->customer_type}}</option>
