...
<div class="content">
    <div class="container-fluid"> 
        <div class="row mb-2">
            <div class="col-12">
                <button type="button" class="btn bg-olive font-weight-bold  DIS-ONCLICK" data-display="listDataOpname"><i class="fa-solid fa-table-list"></i> List Data Opname</button>
                <button type="button" class="btn bg-lightblue font-weight-bold  DIS-ONCLICK" data-display="listInputBarang"><i class="fa-solid fa-plus"></i> Entry Data</button>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
