            ...
            <div class="card-body table-responsive p-2">
                <div class="row d-flex justify-content-end">
                    <div class="col-12">
                        ...
                        <button class="btn btn-sm btn-light border-0 font-weight-bold pl-4" id="cencelDocument" data-doc="{{$opnameNumber}}"><i class="fa-solid fa-xmark"></i>| Batalkan Transaksi</button>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-12">
