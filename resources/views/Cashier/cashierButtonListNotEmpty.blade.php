    ...
    <div class="card-body text-xs">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                ...
                <input type="text" name="noStruck" id="noStruck" class="form-control " value="" readonly>
            </div>
        </div>
        <hr>
        <div class="form-group row">
        ...
        <div class="row mb-2">
            ...
            <div class="col-4">
                <button type="button" class="btn bg-gray-dark elevation-2 btn-block border border-2 border-light p-2" id="btnLoad"><b>[Ctrl+L]</b> <br> LOAD</button>
            </div>
            <div class="col-4">
