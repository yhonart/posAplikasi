                    ...
                    <div class="col-md-12">
                        <form id="formPembayaran">
                            ...
                            <div class="form-group row mb-1 d-flex align-items-center" id="divMethod1">
                                ...
                                <div class="col-md-4">
                                    <a href="#radioMethod" id="btnDuaMethod" class="btn btn-outline-primary border-0 font-weight-bold" onclick="myFunctionChecked()">Menggunakan 2 Metode Pembayaran</a>
                                </div>
                            </div>
                            ...
                            <div class="row" id="duaMetodePembayaran">
                                <div class="col-12"> 
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label font-weight-bold">2 Metode Pembayaran</label>
                                    </div>
                                </div>
                            </div>
        ...
        document.addEventListener('keydown', function(event) {
            if (event.ctrlKey && event.key === 's') { // Cetak
                ...
                // }
                    ...
                    alertify
                    .alert("Wajib Pilih Check List LUNASI HUTANG untuk melakukan pelunasan hutang !", function(){
                        alertify.message('Transaksi kredit di batalkan.');
                    }).set({title:"Konfirmasi Limit Hutang"});                    
                }
                else if ((words2[2] === "KREDIT" && kreditLimit === '0') || (onePayment === '8' && kreditLimit === '0')) {
                    alertify
                    .alert("Pelanggan ini tidak memiliki limit kredit !", function(){
                        alertify.message('Transaksi kredit di batalkan.');
                    }).set({title:"Konfirmasi Limit Hutang"});                    
                }
                else if ((words2[2] === "KREDIT" && parseInt(replaceTotalPembayaran) > parseInt(kreditLimit)) || (onePayment === '8' && parseInt(replaceTotalPembayaran) > parseInt(kreditLimit))) {
