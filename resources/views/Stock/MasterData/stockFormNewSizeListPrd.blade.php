...
<tr>
    <td class="border p-0">
        <select name="onChangeSize" id="onChangeSize" class="form-control form-control-sm " onchange="saveToDatabase(this,'m_product_unit','product_size','{{$deu->idm_product_satuan}}','idm_product_satuan','{{$deu->core_id_product}}')" {{$disabled}}>
    ...
    <td class="border p-0">
        <select name="onChangeSize" id="onChangeSize" class="form-control form-control-sm " onchange="saveToDatabase(this,'m_product_unit','product_satuan','{{$deu->idm_product_satuan}}','idm_product_satuan','{{$deu->core_id_product}}')">
    ...
    <td class="border p-0">
        <input type="text" onchange="saveToDatabase(this,'m_product_unit','product_volume','{{$deu->idm_product_satuan}}','idm_product_satuan','{{$deu->core_id_product}}')" value="{{$deu->product_volume}}" class="form-control form-control-sm ">
    </td>
    <td class="border p-0">
        <input type="text" onchange="saveToDatabase(this,'m_product_unit','set_barcode','{{$deu->idm_product_satuan}}','idm_product_satuan','{{$deu->core_id_product}}')" value="{{$deu->set_barcode}}" class="form-control form-control-sm ">
    </td>
    <td class="p-0">
