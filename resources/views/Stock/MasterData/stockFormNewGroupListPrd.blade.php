            ...
            <tr>
                ...
                <td class="p-0">
                    @if($mPrd->size_code == '1' OR $mPrd->product_price_sell == "")
                        <input class="form-control form-control-sm" name="editPriceOrder" id="editPriceOrder" value="{{$mPrd->product_price_order}}" onchange="saveToDatabase(this,'m_product_unit','product_price_order','{{$mPrd->idm_product_satuan}}','idm_product_satuan','{{$mPrd->core_id_product}}')">
                    @else
