                                    ...
                                    <?php
                                        foreach ($detailPotongan as $dp) {
                                            if ($dp->supplier_id == $ltp->supplier_id && $ltp->voucher == '0') {
                                                ...
                                                echo "<button class='btn btn-sm btn-warning BTN-OPEN-MODAL-GLOBAL-LG' href='".route('Purchasing')."/modalVoucher/".$ltp->supplier_id."' ><i class='fa-solid fa-ticket'></i> Voucher</button>";
                                            }
