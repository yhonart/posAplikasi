...
<div id="tableDocMutasi">
    <div class="row mb-2">
        <div class="col-12 d-flex float-right">
            ...
            <span class="pl-2"><b>Lokasi Anda :</b>{{$mloc->site_name}}</span>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-body table-responsive">
                <table class="table table-sm table-valign-middle table-hover table-bordered text-nowrap">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @if($tm->status <> '0')
                                        ...
                                        <button type="button" class="btn btn-sm btn-danger btnDelete btn-flat font-weight-bold" title="Delete" data-opname="{{$tm->number}}"><i class="fa-solid fa-trash"></i> Batalkan Mutasi</button>
                                        @endif
