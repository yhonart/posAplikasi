...
@foreach($listMutasi as $lsm)
    <tr>
        ...
        <td class="p-0">
            <input type="number" name="editJumlah" id="editJumlah" value="{{$lsm->stock_taken}}" onchange="saveUpdateMutasi(this,'inv_moving_list','stock_taken','{{$lsm->idm_list}}','idm_list')" class="form-control form-control-sm rounded-0 form-control-border" onfocus="this.select()">
            
        </td>
        <td class="p-0">
            <input type="text" name="editNote" id="editNote" value="{{$lsm->notes}}" class="form-control form-control-sm rounded-0 form-control-border" onchange="saveUpdateMutasi(this,'inv_moving_list','notes','{{$lsm->idm_list}}','idm_list')" onfocus="this.select()">
        </td>
        <td class="p-0 ">
