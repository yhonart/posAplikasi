...
<div class="row mb-2">
    <div class="col-md-12">
        <button class="btn btn-info font-weight-bold elevation-1" id="closeDetail">Tutup</button>
        <button class="btn btn-primary font-weight-bold elevation-1" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
            Detail Dokumen
         </button>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card card-body border-0 elevation-0">
