    ...
    <tbody>
        @foreach($tbPurchase as $pr)
            <tr>
                ...
                <td class="text-right"> 
                    <button class="btn btn-sm btn-primary font-weight-bold DIS-ITEM" title="Retur Item" data-purchase="{{$pr->purchase_number}}"><i class="fa-solid fa-rotate-right"></i> Retur</button>
                    <button class="btn btn-sm btn-info font-weight-bold DETAIL-ITEM" title="Detail" data-purchase="{{$pr->purchase_number}}"><i class="fa-solid fa-magnifying-glass"></i> Detail</button>
                </td>
            </tr>
        @endforeach
    </tbody>
