...
use Illuminate\Support\Facades\Route;
    ...
    Route::get('sales/mainKurir/detailHistoryData/{dataID}', [App\Http\Controllers\KurirController::class, 'detailHistoryData']);
    ...
    Route::get('sales/mainKurir/addNewNonSchedule', [App\Http\Controllers\KurirController::class, 'addNewNonSchedule']);
