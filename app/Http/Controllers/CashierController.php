...
//         $listDataSelling = $listDataSelling->paginate(10);
        ...
        return view ('Cashier/cashierModalDataPenjualanList', compact('listDataSelling','countBelanja','area'));
    }
    ...
    public function cashierReportDetailPdf ($fromDate, $endDate){
        ...
        $tableMthodPayment = DB::table('view_trx_method');
            ...
            $tableMthodPayment = $tableMthodPayment->where('status_by_store','!=','2');
